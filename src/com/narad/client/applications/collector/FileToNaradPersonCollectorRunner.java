...
public class FileToNaradPersonCollectorRunner {
	private static final Logger logger = LoggerFactory.getLogger(FileToNaradPersonCollectorRunner.class);
	...
	public static void main(String[] args) throws Exception {
		FileToNaradPersonCollectorRunner friendFeedRunner = new FileToNaradPersonCollectorRunner(
				"D:\\development\\narad\\data_sources\\live_inbox", "liveInbox", null);
		friendFeedRunner.runCollectorAsync();
	}

	public FileToNaradPersonCollectorRunner(String baseFilePath, String network, String filePath) throws Exception {
		super();
